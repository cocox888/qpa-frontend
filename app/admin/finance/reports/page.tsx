...
export default function Notes() {
  ...
  const newReportHandle = async () => {
    ...
    const report = await fetch(
      `${process.env.NEXT_PUBLIC_PRODUCT_BACKEND_URL}/admin/newreport`,
      {
        method: 'POST',
        headers: {
        ...
        body: JSON.stringify({ project, revenue, startDate, endDate })
      }
    );
        ...
        <div className=" mx-auto space-y-6">
          ...
          <div className="gradient-border card-shine p-4 rounded-xl bg-white">
            ...
            <div className="flex gap-2 py-3">
              <div className="text-md">Revenue Type:</div>
              <div>
                {' '}
                <select
                  id="project"
