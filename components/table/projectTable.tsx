            ...
            data.map((item, index) => {
              return (
                <tr className="table-row-hover">
                  ...
                  <td className="px-4 py-3 text-gray-600">{item.projectClient?.full_name}</td>
                  ...
                  <td className="px-4 py-3">
                    <div className="w-full bg-gray-100 rounded-full h-1.5 overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${Number(phaseMap.get(item.project_phase || "")) / 4 * 100}%`,
                          background:
                            'linear-gradient(90deg, rgba(132, 184, 148, 0.8), rgba(132, 184, 148, 1))'
                        }}
                      />
                    </div>
                    <div className="text-xs text-gray-500 mt-1">{`${Number(phaseMap.get(item.project_phase || "")) / 4 * 100}%`} Complete</div>
                  </td>
                  <td className="px-4 py-3">
